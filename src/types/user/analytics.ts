...
export const getTasksFromAnalytics = (analytics: AnalyticsDto): OnboardingTask[] => {
  return analytics?.checklist?.tasks ?? [];
};

export const getRecommendedDatasourcesFromAnalytics = (analytics: AnalyticsDto): string[] => {
...
export const getRecommendedDatasourcesFromAnswers = (surveyAnswers: SurveyAnswers): string[] => {

...
import { AgentStatus } from '../organization/agent';
...
export interface CommonMetrics {
  cpu?: si.Systeminformation.CurrentLoadData | number;
  memory?: si.Systeminformation.MemData | number;
  disk?: si.Systeminformation.FsSizeData[];
  io?: si.Systeminformation.NetworkStatsData[];
  uptime?: number;
  reported_at?: Date;
  deployed_at?: Date;
  version?: string;
...
// Backwards compatible naming change.
//
// eslint-disable-next-line @typescript-eslint/no-empty-interface
export interface ControllerMetrics extends Metrics {}
